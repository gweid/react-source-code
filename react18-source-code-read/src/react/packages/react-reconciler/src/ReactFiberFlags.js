...
export const Snapshot = /*                     */ 0b0000000000000000010000000000; // 1024 根fiber
...
export const PlacementDEV = /*                 */ 0b0010000000000000000000000000; // 33554432 box-border
...
// 不会在克隆时重置的tag的并集。
// 这允许某些概念持续存在，而无需重新计算它们，
// 例如，一个子树是否包含passive effects或portals
